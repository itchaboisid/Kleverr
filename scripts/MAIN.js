        ...
        themedContents.forEach((themedContent) => {
            themedBackgrounds.forEach((themedBackground) => {
                if (this.checked) {
                    ...
                    navLogo.src = '/assets/images/logos/logo.png';
                } else {
                    ...
                    bg.style.backgroundImage = 'var(--orange-gradient)';
                    navLogo.src = '/assets/images/logos/logo2.png';
                }
            });
        });
    });
...
function playLoginAnimation() {
    if (window.matchMedia('(max-width: 420px)').matches) {
        applyAnimationOnElement(loginModal, 'animate__fadeIn');
    }
    else {
...
function backToMainMenu() {
    ...
    landingPage.style.backgroundImage = `url("/assets/images/background/background-animated.gif")`;
